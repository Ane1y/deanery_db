...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupPointerComboBox1_2 = QtWidgets.QComboBox(self.verticalLayoutWidget_5)
        self.groupPointerComboBox1_2.setObjectName("groupPointerComboBox1_2")
        self.horizontalLayout_13.addWidget(self.groupPointerComboBox1_2)
        self.changeNameOfSubjectLinEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget_5)
        self.changeNameOfSubjectLinEdit.setObjectName("changeNameOfSubjectLinEdit")
        self.horizontalLayout_13.addWidget(self.changeNameOfSubjectLinEdit)
        self.changeNameOfSubjectButton = QtWidgets.QPushButton(self.verticalLayoutWidget_5)
        self.changeNameOfSubjectButton.setObjectName("changeNameOfSubjectButton")
        self.horizontalLayout_13.addWidget(self.changeNameOfSubjectButton)
        ...
        self.subjectComboBox3 = QtWidgets.QComboBox(self.verticalLayoutWidget_5)
        self.subjectComboBox3.setObjectName("subjectComboBox3")
        self.horizontalLayout_12.addWidget(self.subjectComboBox3)
        self.label_11 = QtWidgets.QLabel(self.verticalLayoutWidget_5)
        self.label_11.setObjectName("label_11")
        self.horizontalLayout_12.addWidget(self.label_11)
        self.subjectComboBox4 = QtWidgets.QComboBox(self.verticalLayoutWidget_5)
        self.subjectComboBox4.setObjectName("subjectComboBox4")
        self.horizontalLayout_12.addWidget(self.subjectComboBox4)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "Удалить группу с самым маленьким  баллом и студентов,принадлежащих ей"))
        self.label_15.setText(_translate("Dialog", "Какая группа была удалена"))
        self.pushButton_17.setText(_translate("Dialog", "если в удаленной группе читались 3 предмета – транзакцию откатить"))
        self.label_17.setText(_translate("Dialog", "Состояние"))
...
" попавшим в этот интервал"))
        ...
        self.label_23.setText(_translate("Dialog", "Все предметы, по которым в заданном году\n"
...
",  и средний балл по каждому из предметов"))
        ...
        self.changeNameOfSubjectButton.setText(_translate("Dialog", "Поменять название предмета"))
        ...
        self.pushButton_15.setText(_translate("Dialog", "Да!"))
        self.label_14.setText(_translate("Dialog", "Eсли преподаватель, читающий удаляемый предмет, больше ничего не читает – откатить транзакцию."))
        self.label_10.setText(_translate("Dialog", "Какой предмет удалить"))
        self.label_11.setText(_translate("Dialog", "На какой заменить"))
        self.pushButton_13.setText(_translate("Dialog", "Да!"))
        self.label_20.setText(_translate("Dialog", "Вывести студентов и наименования предметов, включая предметы,\n"
